...
_G.packer_plugins = {
  ...
  everforest = {
    loaded = true,
    path = "/home/grace/.local/share/nvim/site/pack/packer/start/everforest",
  ...
  ["glow.nvim"] = {
    loaded = true,
    path = "/home/grace/.local/share/nvim/site/pack/packer/start/glow.nvim",
  ...
  neorg = {
    ...
    loaded = true,
    path = "/home/grace/.local/share/nvim/site/pack/packer/start/neorg",
  ...
  ["nvim-tree.lua"] = {
    ...
    loaded = true,
    path = "/home/grace/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/home/grace/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
